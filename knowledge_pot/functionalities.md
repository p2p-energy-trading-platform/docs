...
This document lists all functionalities available to a **Prosumer** in the Peer-to-Peer Energy Trading Platform. A prosumer is a participant who can both **produce** and **consume** electricity by selling surplus solar energy and purchasing energy from other users in the marketplace.
